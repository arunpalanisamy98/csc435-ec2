[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-24ddc0f5d75046c5622901739e7c5dd533143b0c8e959d652212380cedb1ea36.svg)](https://classroom.github.com/a/8dIUSObY)
[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-718a45dd9cf7e7f842a935f5ebbe5719a5e09af4491e668f4dbf3b35d5cca122.svg)](https://classroom.github.com/online_ide?assignment_repo_id=14284832&assignment_repo_type=AssignmentRepo)
...
```
./build/file-retrieval-server <IP address> <port>
> <quit>
```

To run the C++ client (after you build the project) use the following command:
```
./build/file-retrieval-client <IP address> <port>
> <index | search | quit>
```
...
Server
```
./build/file-retrieval-server 127.0.0.1 12345
>
```
...
Client 1
```
./build/file-retrieval-client 127.0.0.1 12345
...
```
java -cp target/app-java-1.0-SNAPSHOT.jar csc435.app.FileRetrievalServer <IP address> <port>
> <quit>
```

To run the Java client (after you build the project) use the following command:
```
java -cp target/app-java-1.0-SNAPSHOT.jar csc435.app.FileRetrievalClient <IP address> <port>
> <index | search | quit>
```
...
Server
```
java -cp target/app-java-1.0-SNAPSHOT.jar csc435.app.FileRetrievalServer 127.0.0.1 12345
>
```
...
Client 1
```
java -cp target/app-java-1.0-SNAPSHOT.jar csc435.app.FileRetrievalClient 127.0.0.1 12345
Connection successful!
>
```
